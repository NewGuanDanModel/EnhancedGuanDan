...
from agents.dqn.guandan_agent import MCAgent
...
parser.add_argument('--pool_size', type=int, default=1024, help='The max length of data pool')
parser.add_argument('--batch_size', type=int, default=32, help='The batch size for training')
parser.add_argument('--training_freq', type=int, default=2,
...
parser.add_argument('--record_throughput_interval', type=int, default=5,
...
parser.add_argument('--ckpt_save_freq', type=int, default=100, help='The number of updates between each weights saving')
